...
from apps.views import ProductListView, ProductDetailView, SettingsUpdateView, RegisterCreateView, LogoutView, \
    ...
    ReviewCreateView, OrderListView, OrderDetailView, OrderDeleteView, OrderCreateView, FavouriteView, \
    OrderPdfCreateView, CustomLoginView, ProductGridVIew

urlpatterns = [
    path('', ProductListView.as_view(), name='list_view'),
    path('product-grid', ProductGridVIew.as_view(), name='grid_view'),
    ...
    path('create-review/<int:pk>', ReviewCreateView.as_view(), name='create_review'),
